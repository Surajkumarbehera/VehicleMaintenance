   ...
   loginUser(userObj: { username: any; password: any; }):Observable<Object>
    {
       ...
       return this._httpClient.post('http://ivms:9090/myapp/user/login', JSON.stringify(userObj),{headers:this.httpHeaders});
    ...
    registerUser(userProfileObj : any):Observable<Object>
    {
      ...
      return this._httpClient.post('http://ivms:9090/myapp/user/register', JSON.stringify(userProfileObj), {headers:this.httpHeaders});
    ...
    {   
      return this._httpClient.post('http://ivms:9090/myapp/user/data',{params:{'user_id':userId}});
